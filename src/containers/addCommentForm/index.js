...
class addCommentForm extends Component {
  ...
  render() {
    ...
    if (this.props.active) {
      form = <div className="form-backdrop">
              <div 
                autoComplete="off" 
                ...
                <br/>
                <label className="text-light" htmlFor="">Comment: </label>
                <Comment onchange={this.onChangeHander} />
                <br/>
                <SubmitBtn submit={() => {this.props.addComment({...this.state, time: getTimeStamp()}, this.props.targetRestaurant)}} />
...
const mapDispatch = dispatch => {
  return {
    addComment: (commentObject, targetRestaurant) => {dispatch(addComment(commentObject, targetRestaurant))}
  }
}
